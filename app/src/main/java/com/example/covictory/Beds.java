...
public class Beds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityBedsBinding.inflate(getLayoutInflater());
        ...
        binding.spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position==0)
                {
                    city=new ArrayAdapter<>(Beds.this,R.layout.district,city_jhar);
                }
                else if(position==1)
                {
                    city=new ArrayAdapter<>(Beds.this,R.layout.district,city_bihar);
                }
                else if (position==2)
                {
                    city=new ArrayAdapter<>(Beds.this,R.layout.district,city_wb);
                }
    ...
    private void viewData(String state_name, String city_name) {
        Cursor cursor=new DbHelperBeds(this).viewData();
    ...
    void adding_values_to_arrays()
    {
        ...
        city_wb.add("Howrah");
        city_wb.add("Purulia");
        city_wb.add("North 24 Paraganas");
        city_wb.add("Bankura");
        ...
        city_bihar.add("Kishanganj");
        city_bihar.add("Muzzafarpur");
    ...
    void load_initial()
    {
        state_adapter=new ArrayAdapter<>(Beds.this,R.layout.state,state);
        binding.spinnerState.setAdapter(state_adapter);
        city=new ArrayAdapter<>(Beds.this,R.layout.city,city_jhar);
        binding.spinnerCity.setAdapter(city);
