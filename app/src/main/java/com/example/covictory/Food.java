...
public class Food extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.spinnerState.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position==0)
                {
                    city=new ArrayAdapter<>(Food.this,R.layout.district,city_jhar);
                }
                else if(position==1)
                {
                    city=new ArrayAdapter<>(Food.this,R.layout.district,city_bihar);
                }
                else if (position==2)
                {
                    city=new ArrayAdapter<>(Food.this,R.layout.district,city_wb);
                }
    ...
    private void viewData(String state_name, String city_name) {
        Cursor cursor=new DbHelper(this).viewData();
    ...
    void load_initial()
    {
        state_adapter=new ArrayAdapter<>(Food.this,R.layout.state,state);
        binding.spinnerState.setAdapter(state_adapter);
        city=new ArrayAdapter<>(Food.this,R.layout.city,city_jhar);
        binding.spinnerCity.setAdapter(city);
